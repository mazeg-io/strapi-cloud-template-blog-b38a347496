...
export interface ApiAdvisorAdvisor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Strategic advisors and partners displayed on the landing page';
    displayName: 'Advisor';
    pluralName: 'advisors';
...
export interface ApiContactInfoContactInfo extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Contact information displayed on the landing page';
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Partner companies displayed in the Trusted By section';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiSectorSector extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industry sectors for the landing page';
    displayName: 'Sector';
    pluralName: 'sectors';
    singularName: 'sector';
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Support services displayed on the landing page';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    iconColor: Schema.Attribute.Enumeration<['blue', 'orange']> &
      Schema.Attribute.Required &
